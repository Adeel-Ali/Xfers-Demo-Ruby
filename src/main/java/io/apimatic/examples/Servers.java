...
public enum Servers {
    ORACLE, //TODO: Write general description for this element
    APIMATICHOST; //TODO: Write general description for this element
    ...
    static {
        ORACLE.value = "Oracle";
        APIMATICHOST.value = "APIMaticHost";

        valueMap.put("Oracle", ORACLE);
        valueMap.put("APIMaticHost", APIMATICHOST);
    }
