...
### <a name="get_calculate_for_xfers_async"></a>![Method: ](https://apidocs.io/img/method.png "io.apimatic.examples.controllers.SimpleCalculatorController.getCalculateForXfersAsync") getCalculateForXfersAsync

> Calculates the expression using the specified operation


```java
void getCalculateForXfersAsync(
...
```java
GetCalculateForXfersInput collect = new GetCalculateForXfersInput();
...
simpleCalculator.getCalculateForXfersAsync(collect, new APICallBack<Double>() {
